...
export function SidebarUser() {
    ...
    return (
      <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/10 dark:to-blue-900/10 rounded-lg mx-2">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-medium text-purple-600">Loading...</p>
        </div>
      </div>
    );
  }
  ...
  if (!displayUser) {
    return (
      <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/10 dark:to-blue-900/10 rounded-lg mx-2">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-medium text-purple-600">Not signed in</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <div className="flex-1 min-w-0 text-left">
            <span className="truncate font-medium text-purple-900 dark:text-purple-100">
              {displayName}
            </span>
      ...
      <DropdownMenuContent
        className="w-56 border-purple-200"
        align="end"
        forceMount
      >
